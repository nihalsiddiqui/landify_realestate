                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="post"  enctype="multipart/form-data" action="{{route('features.update',$feature->id)}}" class="form form-horizontal">
                                        {{csrf_field()}}
                                        {{method_field('PUT')}}
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input type="number" id="Count" class="form-control"
                                                               name="code" value="{{$feature->code}}" placeholder="Count" />
                                                        @error('code')
                                                        <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                    </div>
