@section('page_title', 'All Listing')
...
@section('quillStyle')
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset("second-admin/app-assets/vendors/css/pickers/flatpickr/flatpickr.min.css")}}">
...
@section('quillJs')
    ...
    <script
        src="{{asset("second-admin/app-assets/vendors/js/tables/datatable/datatables.bootstrap4.min.js")}}"></script>
    <script
        src="{{asset("second-admin/app-assets/vendors/js/tables/datatable/dataTables.responsive.min.js")}}"></script>
        ...
        $(document).ready(function () {
            dataListView = $(".data-list-view").DataTable({
                ...
                columns: [
                    ...
                    <div class="alert alert-danger p-1">{{ Session::get('error') }}</div>
                        @endif
                    {data: 'slug', name: 'slug'},
