@section('page-title','Edit Appliance')
                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Edit Appliance</h4>
                                </div>
                                <div class="card-body">
                                    <form role="form" method="post"
                                          action="{{route('user.appliance.update',$appliance->id)}}" class="form form-horizontal">
                                        {{ csrf_field() }}
                                        {{ method_field('PUT') }}
                                        <div class="row">
                                            <div class="col-12">
                                            ...
                                            <div class="col-sm-9 offset-sm-3">
                                                ...
                                                <a href="{{route('user.appliance.list')}}" class="btn btn-outline-secondary">Back</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
