...
<section class="py-5">
    <div class="container">
        <div class="col-md-8 col-sm-12 col-xs-12 " style="width:100%;margin: auto;background:#fff; padding:37px;">
            ...
            <div class="row" style="margin: auto;width: 71%;!important;">

                <div  class="col-md-12 col-sm-12">
                    <h4 style="margin-bottom: auto!important;">Your property have been submitted to admin and will
                        return back message from admin on email so check your mail</h4>
                </div>
