                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form enctype="multipart/form-data" class="form form-horizontal" method="post" action="{{route('user.profile.update')}}">
                                        {{csrf_field()}}
                                        {{method_field('PUT')}}
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="number" class="form-control " id="phone" value="{{auth()->user()->phone}}" name="phone" placeholder="Enter Phone">
                                                    @error("phone")
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                    <div class="form-group ">
                                                        ...
                                                        <img style="height:50px; width:84px;" src="{{ asset(auth()->user()->image) }}" />
                                                        @error("image")
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="card-body">
                                                            <textarea class="ckeditor"  name="description">{{auth()->user()->description}}</textarea>
                                                            @error("body")
                                                            <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form class="form form-horizontal" method="post" action="{{route('user.profile.password.update')}}">
                                        {{csrf_field()}}
                                        {{method_field('PUT')}}
                                        <div class="row">
