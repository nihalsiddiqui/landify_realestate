                    ...
                    <div class="row match-height">
                        ...
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="card card-congratulation-medal">
                                <div class="card-body">
                                    <h5 style="font-size: 1.8rem;">Welcome Back</h5>
                                    <p class="card-text font-small-3 text-capitalize" style="margin-bottom: 3rem;"><b style="font-size:1.5rem;">{{auth()->user()->name}}</b></p>
                                        ...
                                        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                                            <div class="media">
                                                ...
                                                <div class="media-body my-auto">
                                                    <h4 class="font-weight-bolder mb-0">{{$userListing}}</h4>
...
{{--                                                </div>--}}
{{--                                                <div class="media-body my-auto">--}}
{{--                                                    <h4 class="font-weight-bolder mb-0">{{$userFacility}}</h4>--}}
{{--                                                    <p class="card-text font-small-3 mb-0">Facilities</p>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
...
{{--                                                </div>--}}
{{--                                                <div class="media-body my-auto">--}}
{{--                                                    <h4 class="font-weight-bolder mb-0">{{$userFeature}}</h4>--}}
{{--                                                    <p class="card-text font-small-3 mb-0">Features</p>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
...
{{--                                                </div>--}}
{{--                                                <div class="media-body my-auto">--}}
{{--                                                    <h4 class="font-weight-bolder mb-0">{{$userAppliance}}</h4>--}}
{{--                                                    <p class="card-text font-small-3 mb-0">Appliances</p>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
                                    </div>
